> [← ¿Qué es el sistema?](01-Que-es-el-sistema.md) · [Índice](00-Indice.md) · [Modo público (sin login) →](03-Modo-Publico.md)

# Primeros pasos

> Cómo acceder al sistema, instalar la app en el celular y entender cómo sincroniza. Para la visión general del sistema ver [01-Que-es-el-sistema](01-Que-es-el-sistema.md).
