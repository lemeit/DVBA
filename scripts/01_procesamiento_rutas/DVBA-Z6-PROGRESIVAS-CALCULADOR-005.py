"""
DVBA-Z6-PROGRESIVAS-CORRECTOR-005.py
===========================================================
...
VERSION: 2025.10.5.0 (Generado: 2025-10-30)
CODIGO: DVBA-Z6-PROGRESIVAS-CORRECTOR-005
...
# DICCIONARIO DE SENTIDOS POR RUTA (MEJORADO)
SENTIDOS_RUTAS = {
    6: "NORTE-SUR",
    20: "OESTE-ESTE", 
    24: "NOROESTE-SURESTE",
...
def determinar_sentido_manual_rp91():
    """
    Sentido manual para RP91 basado en análisis de coordenadas
    Mojón 0: (-59.787337, -35.692950) → NW
    Mojón 50: (-59.346455, -35.928745) → SE
...
def calcular_progresiva_corregida_rp91(fila):
    ...
    print(f"  DEBUG RP91: Coord punto({punto_x:.0f}, {punto_y:.0f})")
