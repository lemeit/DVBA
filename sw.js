...
const CACHE_NAME = 'dvba-campo-v9.95.21';  // v9.95.21 · Sello: km minúscula (SI) + labelDe() para estado en enum → texto humano + tipos: +Vehículo abandonado/-Reparación tranquera, Guardarrail (tipo Flex Beam)
